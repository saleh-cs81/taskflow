...
public class MessageLocalizer : IMessageLocalizer
{
    private static readonly Dictionary<string, Dictionary<string, string>> Messages = new()
    {
        ["en"] = new()
        {
            ...
            ["integration.invalid_key"] = "The Paymo API key is invalid.",
            ["integration.not_connected"] = "Connect a Paymo account before running a migration.",
        ...
        ["ar"] = new()
        {
            ...
            ["integration.invalid_key"] = "مفتاح Paymo API غير صالح.",
            ["integration.not_connected"] = "يجب ربط حساب Paymo قبل تشغيل عملية الترحيل.",
