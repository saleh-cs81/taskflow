...
namespace TaskFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260812075645_AddDepartmentMembers")]
    partial class AddDepartmentMembers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Booking", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.ClientContact", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.DepartmentMember", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.EntityMapping", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "EntityType", "PaymoId")
                        .IsUnique();

                    b.ToTable("EntityMappings", (string)null);
                });

            modelBuilder.Entity("TaskFlow.Domain.Entities.Estimate", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.EstimateLineItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Expense", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Invoice", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.InvoiceLineItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.InvoicePayment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.MigrationError", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("MigrationJobId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("MigrationErrors", (string)null);
                });

            modelBuilder.Entity("TaskFlow.Domain.Entities.MigrationJob", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("TargetPaymoProjectId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.MigrationProjectItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("LocalProjectId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long>("PaymoProjectId")
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TenantId", "PaymoProjectId")
                        .IsUnique();

                    b.ToTable("MigrationProjectItems", (string)null);
                });
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.PaymoConnection", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("PaymoConnections", (string)null);
                });
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Plan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.RecurringTaskRule", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Subscription", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.EstimateLineItem", b =>
                {
                    b.HasOne("TaskFlow.Domain.Entities.Estimate", "Estimate")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("TaskFlow.Domain.Entities.Invoice", "Invoice")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Subscription", b =>
                {
                    b.HasOne("TaskFlow.Domain.Entities.Plan", "Plan")
                        .WithMany()
