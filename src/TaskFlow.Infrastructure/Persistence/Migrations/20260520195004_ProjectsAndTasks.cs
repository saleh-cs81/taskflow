        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetHours = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Color = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedById = table.Column<long>(type: "bigint", nullable: true),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MilestoneId = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DueDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EstimateHours = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_TenantId_TargetType_TargetId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectCategories_TenantId_Name",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskLists_ProjectId_Position",
                table: "TaskLists",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_TaskListId_Position",
                table: "Tasks",
                columns: new[] { "TaskListId", "Position" });
